...
class SequentialListItemChangeDetectorTest {

    private final SequentialListItemChangeDetector<Item> detector = new SequentialListItemChangeDetector<>(
    ...
    void constructor_whenNullComparator_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new SequentialListItemChangeDetector<Item>(
                null, (item1, item2) -> Objects.equals(item1.content(), item2.content())));
    }
