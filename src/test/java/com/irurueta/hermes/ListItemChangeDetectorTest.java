...
class ListItemChangeDetectorTest {

    private final ListItemChangeDetector<Item> detector = new ListItemChangeDetector<>(
            (item1, item2) -> item1.id() == item2.id(),
            (item1, item2) -> Objects.equals(item1.content(), item2.content()));

    @Test
    void constructor_whenNullComparator_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new ListItemChangeDetector<Item>(null,
                (item1, item2) -> Objects.equals(item1.content(), item2.content())));
    }

    @Test
    void constructor_whenNullContentComparator_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new ListItemChangeDetector<Item>(
                (item1, item2) -> item1.id() == item2.id(), null));
    }
    ...
    void detectChanges_whenInsertAtBeginning_returnsExpectedResult() {
        ...
        final var insertedChange = assertInstanceOf(InsertedListItemChange.class, change1);
        ...
        final var moveChange = assertInstanceOf(MovedListItemChange.class, change2);
    ...
    void detectChanges_whenMultipleInserts_returnsExpectedResult() {
        ...
        final var moveChange = assertInstanceOf(MovedListItemChange.class, change3);
        assertSame(item1, moveChange.getOldItem());
        assertSame(item1, moveChange.getNewItem());
        assertEquals(0, moveChange.getOldPosition());
        assertEquals(1, moveChange.getNewPosition());
    ...
    void detectChanges_whenRemoveAtBeginning_returnsExpectedResult() {
        ...
        assertSame(item1, moveChange.getOldItem());
        assertSame(item1, moveChange.getNewItem());
        assertEquals(1, moveChange.getOldPosition());
        assertEquals(0, moveChange.getNewPosition());
    }
    ...
    void detectChanges_whenMultipleRemoves_returnsExpectedResult() {
        ...
        assertEquals(2, removedChange2.getOldPosition());
    ...
    void detectChanges_whenSwap_returnsExpectedResult() {
        ...
        assertEquals(1, moveChange1.getNewPosition());
        ...
        assertEquals(1, moveChange2.getOldPosition());
        assertEquals(0, moveChange2.getNewPosition());
    }
    ...
    void detectChanges_whenReversed_returnsExpectedResult() {
        ...
        assertEquals(ListItemChangeAction.MOVED, change2.getAction());
        final var moveChange2 = assertInstanceOf(MovedListItemChange.class, change2);
        assertSame(item3, moveChange2.getOldItem());
        assertSame(item3, moveChange2.getNewItem());
        assertEquals(2, moveChange2.getOldPosition());
        assertEquals(0, moveChange2.getNewPosition());
    }
    ...
    void detectChanges_whenMultipleActions_returnsExpectedResult() {
        ...
        assertSame(item3, movedChange2.getOldItem());
        assertSame(item3, movedChange2.getNewItem());
        assertEquals(2, movedChange2.getOldPosition());
        assertEquals(0, movedChange2.getNewPosition());
