 ...
 */
public class CollectionItemChangeDetector<T> extends AbstractCollectionItemChangeDetector<T> {
     ...
     */
    public CollectionItemChangeDetector(final ItemComparator<T> itemComparator,
