 ...
 */
public class SequentialListItemChangeDetector<T> extends AbstractSequentialListItemChangeDetector<T> {
     ...
     */
    public SequentialListItemChangeDetector(final ItemComparator<T> itemComparator,
